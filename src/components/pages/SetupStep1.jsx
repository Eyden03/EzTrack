...
export default function SetupStep1() {
  ...
  function handleSubmit(e) {
    ...
    updateProfile(state.profileId, { biz_name: name, biz_type: bizType, biz_city: city.trim(), lang })
          ...
          <div className="flex gap-2">
            <button
              ...
              className={`flex-1 py-3 rounded-xl border text-sm font-semibold transition-all ${
                lang === 'taglish' ? 'border-blue-500 bg-blue-50 text-blue-700' : 'border-gray-200 text-gray-500'
              }`}
            >
              🇵🇭 Taglish
            </button>
            <button
              ...
              className={`flex-1 py-3 rounded-xl border text-sm font-semibold transition-all ${
                lang === 'english' ? 'border-blue-500 bg-blue-50 text-blue-700' : 'border-gray-200 text-gray-500'
              }`}
            >
              🇺🇸 English Only
            </button>
