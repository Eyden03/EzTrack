...
const TABS = [
  ...
  { to: '/app/profile', label: 'Profile', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zm-4 7a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
]

export default function BottomNav() {
  return (
    <nav className="flex border-t border-gray-200 bg-white h-[68px] pb-[env(safe-area-inset-bottom)]">
      {TABS.map(tab => (
        <NavLink
          key={tab.to}
          to={tab.to}
