  ...
  if (subEl) {
    subEl.innerHTML = `
      <div class="settings-item">
        ...
        ${STATE.tier !== 'unlad' ? `<button onclick="goTo('page-plans');renderPlans();" style="background:var(--blue-600);color:white;border:none;border-radius:8px;padding:6px 12px;font-size:12px;font-weight:700;cursor:pointer;">Upgrade</button>` : ''}
      </div>`;
  }
